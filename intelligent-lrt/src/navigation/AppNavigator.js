  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen 
        ...
        options={{ 
          headerShown: true,
          headerTitle: () => <HeaderTitle title="LRT Assistant" isDarkMode={isDarkMode} />,
          headerStyle: { backgroundColor: isDarkMode ? '#121212' : '#FFF' },
      ...
      <Stack.Screen 
        ...
        options={{ 
          headerShown: true,
          headerTitle: () => <HeaderTitle title="Delay Prediction" isDarkMode={isDarkMode} />,
          headerStyle: { backgroundColor: isDarkMode ? '#121212' : '#FFF' },
          headerTintColor: isDarkMode ? '#FFF' : '#000',
        }} 
      />
  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen 
        ...
        options={{ 
          headerShown: true,
          headerTitle: () => <HeaderTitle title="Train Tracking" isDarkMode={isDarkMode} />,
          headerStyle: { backgroundColor: isDarkMode ? '#121212' : '#FFF' },
          headerTintColor: isDarkMode ? '#FFF' : '#000',
        }} 
      />
