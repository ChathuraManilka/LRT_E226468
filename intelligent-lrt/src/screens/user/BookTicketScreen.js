...
const BookTicketScreen = ({ route, navigation }) => {
  ...
  const calculateTotal = () => {
    ...
    try {
      ...
      const paymentStatus = (paymentMethod === 'card' || paymentMethod === 'mobile') ? 'Paid' : 'Pending';
      ...
      if (response.ok) {
        ...
        let alertTitle = 'Booking Successful!';
        let alertMessage = '';
        ...
        if (paymentMethod === 'cash') {
          alertMessage = `Your ticket has been booked successfully!
